...
- [X] Use `npx create-react-app team-builder --use-npm` or `create-react-app team-builder` to initiate the project.
    I used `npx create-react-app .` to download everything into my already created project folder! (per Casey's suggestion)
...
- [X] In `MemberForm.js` build out your markup.
